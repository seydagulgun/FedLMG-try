...
def read_nicopp_data(dataset_path, domain_name, split="train",shotnum=999999999):
    data_paths = []
    data_labels = []
...
def get_nicopp_dataset(transform,divide):
    dataset_path = '/home/seyda/FedLMG-try/FedLMG/datasets/NICO_DG'
...
def read_nicou_data(dataset_path, domain_name, split="train",shotnum=999999999,cate = None):
    ...
    shot = [0 for _ in range(60)]
    class_style = {}
    for i in os.listdir('/home/seyda/FedLMG-try/FedLMG/datasets/NICO_DG/txtlist/NICO_unique_official'):
    ...
    for cla in class_style:
        ...
        file = '/home/seyda/FedLMG-try/FedLMG/datasets/NICO_DG/txtlist/NICO_unique_official/'+'_'.join([c,s])+f'_{split}.txt'
        files.append(file)
    ...
    for split_file in files:
        with open(split_file, "r") as f:
            ...
            for line in lines:
                ...
                data_path = path.join('/home/seyda/FedLMG-try/FedLMG/datasets/NICO_DG', data_path)
                #label = int(label)
